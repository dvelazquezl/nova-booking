class EstatesController < ApplicationController
  ...
  def estate_params
    params.require(:estate).permit(:name, :address, :city_id, :owner_id, :estate_type, :description, :longitude, :latitude, facility_ids: [], images: [], rooms_attributes: [:id, :estate_id, :description, :capacity, :quantity, :price, :status, :room_type, :_destroy, facility_ids: [], images: []])
  end
